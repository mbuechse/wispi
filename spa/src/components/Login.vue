<template>
  <div>
    ...
    <b-form @submit="onSubmit" class="m-3">
      <b-form-group id="gusername" label="Nutzer*in" label-for="username" horizontal :label-cols="2">
        <b-form-input title="username" name="username" placeholder="Nutzer*in" v-model="username"></b-form-input>
      </b-form-group>
      <b-form-group id="password" label="Passwort" label-for="password" horizontal :label-cols="2">
